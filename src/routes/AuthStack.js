...
import Spalsh from '../screens/SpalshScreen/index';
import LoginPhone from '../screens/LoginPhone/LoginPhone.screen';
import LoginPhoneSoc from '../screens/LoginSoc/LoginPhone.screen';
    ...
    <>
      {appMode == 'buyer' ?
        <Stack.Navigator headerMode="none">
          ...
          <Stack.Screen name="LoginPhoneSoc" component={LoginPhoneSoc} />
