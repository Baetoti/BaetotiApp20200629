            ...
            <SafeAreaView style={styles.container}>
                <LinearGradient
                    ...
                    <View style={styles.settingComponentContainer}>
                        <SettingComponent title={languageJson.Notification_PlaceHolder} switchColor={Colors.purplePrimary} />
                        <SettingComponent title={languageJson.OfflineMode_PlaceHolder} switchColor={Colors.purplePrimary} />
