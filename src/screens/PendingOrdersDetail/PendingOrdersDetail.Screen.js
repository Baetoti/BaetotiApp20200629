...
import styles from './PendingOrdersDetail.Style';
                ...
                >
                    ...
                    <ScrollView style={styles.scrollViewStyle}
                        ...
                        {item.selfPickup ?
                            ...
                            //                         Request will be sent after acceptance
                            // </TextRowWise>
                            //                 </LinearGradient>
                        }
                        {/* {item.selfPickup&&
                        ...
                        {/* {!item.selfPickup && !item.selfDelivert &&
                            <View style={styles.providerContainer}>
                        ...
                        <LinearGradient
                            ...
                            <View style={styles.orderDetailTextContainer}>
                                <TextRowVise style={styles.orderDetailText}>{languageJson.OrderDetails_Heading}</TextRowVise>
                            </View>
                            <View style={styles.line} />
                    ...
                    {!isOrderCompleted &&
                        <Button title={languageJson.AcceptOrder_Label} onPress={() => {
                            // navigation.navigate('ProviderHome')
                            if (item.selfPickup == false) {
