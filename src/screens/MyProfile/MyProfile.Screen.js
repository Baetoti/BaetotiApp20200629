...
export default function MyProfile({ navigation }) {
   ...
   */
  const languageJson = useSelector(state => state.Language.languageJson.ProviderMyProfiles_Screen)
      ...
      >
        <ViewRowVise style={styles.ratingInfoView}>
          ...
          <View style={styles.personNameContainer}>
            ...
            {selectedTab == 1 ?
              <Text numberOfLines={2} style={styles.commmentText}>{item.providerRating}</Text> : null
            }
          </View>
    ...
    <Fragment>
      ...
      <SafeAreaView style={styles.Container}>
        <View style={{ backgroundColor: Colors.backgroundWhite }}>
          <ProfileHeader
            title={languageJson.MyProfile_Heading}
            image={editImage}
            onImagePress={() => { console.log("hit"); navigation.navigate('EditProfile') }}
          ...
          <View style={styles.profileContainer}>
            ...
            <View style={styles.bookMarkContainer}>
              ...
              <View style={styles.totalVisitorContainer}>
                ...
                <Text style={styles.totalVisitorText}>{languageJson.TotalVisitors_Label}</Text>
              </View>
            </View>
            <View style={styles.tabContainer}>
              <Tab
                selectedTextColor={Colors.purplePrimary}
                selectedTabText={{ fontWeight: 'bold', color: Colors.purplePrimary }}
        ...
        {/* <Button
          title={languageJson.Logout_Button}
          containerStyle={{
