...
import styles from './ProviderPastOrders.Style';
            ...
            <SafeAreaView style={styles.container}>
                ...
                >
                    ...
                    <ScrollView style={styles.scrollViewStyle}
                        ...
                        {item.selfPickup ?
                            <View style={[styles.acceptanceContainer, { backgroundColor: Colors.backgroundWhite, paddingVertical: 0 }]}>
                                <LinearGradient
                                    ...
                                    <TextRowWise style={styles.acceptanceText}>{languageJson.buyerPickup} Buyer picked himself</TextRowWise>
                                </LinearGradient>
                            </View>
                            :
                            item.selfDelivery == true ?
                                <LinearGradient
                                    start={{ x: 0, y: 0 }}
                                    end={{ x: 1, y: 0.7 }}
                                    locations={[0.1, 0.7]}
                                    ...
                                    style={styles.acceptanceContainer}>
                                    <TextRowWise style={styles.acceptanceText}>Delivered by Store</TextRowWise>
                                </LinearGradient> :
                                <LinearGradient
                                    start={{ x: 0, y: 0 }}
                                    end={{ x: 1, y: 0.7 }}
                        ...
                        {!item.selfPickup && item.selfDelivery == false &&
                            <View style={styles.providerContainer}>
                        ...
                        <LinearGradient
                            ...
                            <ViewRowVise style={styles.orderDetailTextContainer}>
                                ...
                                <TouchableOpacity onPress={() => navigation.navigate('Review', { data: item.client })}>
                    ...
                    {!isOrderCompleted &&
                        <Button title={languageJson.OrderisReady_Button} onPress={() => navigation.navigate('ProviderHome')} containerStyle={{ backgroundColor: Colors.lightPurple, marginTop: height(0) }} />
                    }
                    {/* <TouchableOpacity
                    activeOpacity={0.7}
                    style={styles.printContainer}
                >
                    <Image source={printImage}
